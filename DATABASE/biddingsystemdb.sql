...
`memberid` int(11) NOT NULL,
  ...
  `laststname` varchar(30) NOT NULL,
...
INSERT INTO `member` (`memberid`, `firstname`, `lastname`, `gender`, `userid`, `password`, `email`, `contactno`, `birthdate`, `address`, `verification`, `memberimg`) VALUES
