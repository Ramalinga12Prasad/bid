...
?>
  <div id="main_content">
    ...
    <div class="left_content">
      ...
      <div class="banner_adds"> <a href="#"><img  style="width:250px;height:250px;"src="images/bann2.jpg" alt="" border="0" /></a> </div>
    </div>
    <!-- end of left content -->
		  ...
		  <div class="reg_form">
           ...
           <strong>Contact:</strong> 
            ...
            <select name="day">
				...
				<option>8</option>
				<option>9</option>
				<option>10</option><option>11</option><option>12</option><option>13</option><option>14</option><option>15</option><option>16</option><option>17</option><option>18</option><option>19</option><option>20</option><option>21</option><option>22</option><option>23</option><option>24</option><option>25</option><option>26</option><option>27</option><option>28</option><option>29</option>option><option>30</option><option>31</option>
			</select></br></br>
            <select name="month">
				<option>Month</option>
				<option></option>
