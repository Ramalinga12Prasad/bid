  ...
  <div id="main_content">
    ...
    <div class="left_content">
      ...
      <div class="border_box">
        <div class="product_title"><a href="details.html">Black Tiger</a></div>
        <div class="product_img"><a href="details.html"><img src="images/blacktiger2.jpg" alt="" border="0" /></a></div>
        <div class="prod_price"><span class="reduce">3500$</span> <span class="price">2700$</span></div>
      </div>
	...
	<div class="title_box">Log In</div>
      ...
      <div class="border_box">
        <div class="product_title"><a href="details.html">White Shrimp</a></div>
        <div class="product_img"><a href="details.html"><img src="images/whiteshrimp5.gif" alt="" border="0" /></a></div>
        <div class="prod_price"><span class="reduce">3500$</span> <span class="price">2505$</span></div>
      </div>
      <div class="title_box">companys</div>
      <ul class="left_menu">
        <li class="odd"><a href="#">KSA</a></li>
        <li class="even"><a href="#">ASM</a></li>
        <li class="odd"><a href="#">5STARS</a></li>
        <li class="even"><a href="#">V4</a></li>
        <li class="odd"><a href="#">PRP</a></li>
        <li class="even"><a href="#">ABT</a></li>
        <li class="odd"><a href="#">Martin</a></li>
        <li class="even"><a href="#">AAM</a></li>
      </ul>
